# 1 "d:\\QNX\\QNX_DroneV1\\Module\\Spread\\i2cCUAV\\stm.ino"
# 2 "d:\\QNX\\QNX_DroneV1\\Module\\Spread\\i2cCUAV\\stm.ino" 2
...
{
    uint8_t first_byte = _data & 0b00000000000000000000000011111111;
    uint8_t second_byte = (_data & 0b00000000000000001111111100000000) >> 8;
...
void setup()
{
    ...
    dbug.println(SystemCoreClock); // sua lai chan cho mạch mới

    pinMode(31, 0x1);
    pinMode(((((0xC0 + 1) + 1) + 1) + 1),0x1);
    digitalWriteFast(((((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < 36) ? (PinName)(digitalPin[(uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xC0) == 0xC0) && (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < (0xC0 + 10)) ? (PinName)(digitalPin[analogInputPin[(((((0xC0 + 1) + 1) + 1) + 1)) & 0x3F]] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : NC),0x0);
    ...
    case 1:
        if ((unsigned long)(HAL_GetTick() - sHp.timeDelayRec) > 10)
        {
            ...
            else
            {
                ...
                {
                    dbug.print(sHp.FrameCalibSuccess[x], 16);
                    dbug.print(" ");
                }
                dbug.println();
...
{
    digitalWriteFast(((((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < 36) ? (PinName)(digitalPin[(uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xC0) == 0xC0) && (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < (0xC0 + 10)) ? (PinName)(digitalPin[analogInputPin[(((((0xC0 + 1) + 1) + 1) + 1)) & 0x3F]] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : NC),0x1);
    spread485.write(m);
    spread485.flush();
    digitalWriteFast(((((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < 36) ? (PinName)(digitalPin[(uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xC0) == 0xC0) && (((uint32_t)(((((0xC0 + 1) + 1) + 1) + 1)) & 0xFF) < (0xC0 + 10)) ? (PinName)(digitalPin[analogInputPin[(((((0xC0 + 1) + 1) + 1) + 1)) & 0x3F]] | ((((((0xC0 + 1) + 1) + 1) + 1)) & 0x700)) : NC),0x0);
}
