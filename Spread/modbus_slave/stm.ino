...
void setup()
{
    ...
    SerialSlave.begin(BAUDRATE_MODBUS);
    ...
    while (1)
    {
        ...
        //                 0x01, 
        //                 0x01);
        if (check_connect_master(FR0, READ, WRITE))
        {
...
{ 
    ...
    {
        if (SerialSlave.peek() == SLAVEID)
        {
            SerialSlave.readBytes(recFr,ELE_FRAME);
